...
public class Base_Class {
	...
	public String EMI(String Amount,String Interest, String Tenure) throws MalformedURLException
	{
		...
		//Identify the Price txtbox and enter the values
				...
				driver.findElementById("com.boondoggle.mortcalc:id/var_years").sendKeys(Interest);
				//Identify the Interest txtbox and enter the values
				driver.findElementById("com.boondoggle.mortcalc:id/var_interest").sendKeys(Tenure);
	...
	public void StopServer1() throws ExecuteException, IOException
	{
